...
date: "2024-05-01"
categories: ["10/10", "Horror"]
toc: true
draft: false
---

**Rating**: 10/10 </br>
**Overview**: Gripping horror intertwining four Native American men's lives with their chilling past and its haunting repercussions.

![](theonlygoodindians.jpeg){alt="Cover of the novel 'The Only Good Indians' by Stephen Graham Jones. The cover features a close-up image of a deer with prominent, dark antlers against a black background. The title text is overlaid at the top in white with a distressed font style."}
