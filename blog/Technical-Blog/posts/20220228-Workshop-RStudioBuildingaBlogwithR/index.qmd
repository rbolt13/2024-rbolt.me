...
These are my notes from Posit's (formerly R Studio) ["Building a Blog with R"](https://youtu.be/MrW5XFf7aps) tutorial, which was presented by [Isabella Velasquez](https://ivelasq.rbind.io/about.html). [Materials](https://github.com/ivelasq/2022-01-25_building-a-blog-with-r) available on Github.

![](images/clipboard-3410174469.png)
...
Check out [Posit meet-up](https://www.meetup.com/posit-enterprise-community-meetup/) for more from Posit.
