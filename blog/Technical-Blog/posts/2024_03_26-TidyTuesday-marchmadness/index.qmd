---
title: "Week 13 Tidy NCAA Men's March Madness"
date: "2024-03-26"
categories: ["#TidyTuesday", "R", "Data Visuals"]
draft: false
---

This week's TidyTuesday slam dunks into March Madness, highlighting the discrepancy between actual round winners and fan forecasts. My chart focuses on the bracket busters, where red celebrates teams that surpassed expectations, and blue revealing those that couldn’t shake the pressure. 
...
This code retains its core components of cleaning, visualizing, and styling as past #TidyTuesday submissions, but is instead presented as Set-UP > Clean > Graph > Save. 
...
3. Join team_results and public_picks by TEAM.

4. Calculate the difference between team results and public picks. 
...
[rfordatascience/tidytuesday Repo](https://github.com/rfordatascience/tidytuesday?tab=readme-ov-file)

[rbolt13/tidytuesday Repo](https://github.com/rbolt13/tidytuesday)
